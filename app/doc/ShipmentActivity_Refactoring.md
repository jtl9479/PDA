...
### Step 7. ITEM_TYPE 상수화 ✅ 완료 (2026-01-07)

**현황**: 계근 방식 문자열이 12회 반복 사용됨

- [x] `ITEM_TYPE_W = "W"` - 바코드 계근 (근거: 1209줄 로그 "Type W")
- [x] `ITEM_TYPE_HW = "HW"` - 바코드 계근 확장 (근거: 1158줄 W와 동일 조건 처리)
- [x] `ITEM_TYPE_S = "S"` - 저울 계근 (근거: 1260줄 로그 "Type S")
- [x] `ITEM_TYPE_J = "J"` - 지정 중량 (근거: 1263줄 주석 "지정된 중량 입력")
- [x] `ITEM_TYPE_B = "B"` - 홈플러스 비정량 (근거: 1272줄 주석 "Homeplus 비정량")

**변경 내역**: 193~198줄에 5개 상수 정의, 12회 사용처 변경
...
### Step 11. 센터명 상수화 ✅ 완료 (2026-01-07)

**현황**: 센터명 문자열이 반복 사용됨

- [x] `CENTER_NAME_TRD = "TRD"` - 수입육 센터
- [x] `CENTER_NAME_WET = "WET"` - 수입육 센터
- [x] `CENTER_NAME_ET = "E/T"` - 트레이더스

**변경 내역**: 200~203줄에 3개 상수 정의, contains/split 사용처 변경
...
| Step 11 | 센터명 상수화 | 2026-01-07 | 3개 상수, contains/split 사용처 변경 |
