...
|------|-----------|:-----------------:|
| **M0** | 상품코드6 + 중량6 + 회사코드 + 수입식별번호12 | ✅ 전체 12자리 |
| **M1** | 상품코드6 + 중량6 + 회사코드 | ❌ 미사용 |
| **M3** | 납품코드 + 중량6 + 회사코드 + 수입식별번호12 | ✅ 전체 12자리 |
| **M4** | 납품코드 + 중량6 + 회사코드 | ❌ 미사용 |
| **M8** | 상품코드6 + 중량6 + 회사코드 + 수입식별번호12 | ✅ 전체 12자리 |
| **M9** | 상품코드6 + 수입식별번호12 + 용도코드 | ✅ 전체 12자리 |
| **E0** | 상품코드6 + 중량6 + 회사코드 + 수입식별번호12 | ✅ 전체 12자리 |
| **E1** | 상품코드6 + 중량6 + 회사코드 + 111111111111 | ❌ 고정값 사용 |
