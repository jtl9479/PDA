...
try {
 ...
 //SQL 
  ...
  while(rs.next())
  {
   out.println(rs.getString("GI_D_ID") + "::" + rs.getString("ITEM_CODE") + "::"
			...
			+ rs.getString("EMARTLOGIS_CODE") + "::" + rs.getString("WH_AREA") + "::" + rs.getString("USE_NAME") + "::" + rs.getString("USE_CODE") + "::" + rs.getString("CT_NAME") + "::" + rs.getString("STORE_CODE")+ ";;");
