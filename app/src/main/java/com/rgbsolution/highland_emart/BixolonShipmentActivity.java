...
public class BixolonShipmentActivity extends HoneywellScannerActivity {
     ...
     * </ol>
     *
     * <p>개발66 Step 7 : 위 흐름의 실제 구현은 searchType별 {@link com.rgbsolution.highland_emart.shipment.type.ShipmentType}
     * 구현체로 이관되었다. 이 메서드는 생산(1) 분기와 위임만 담당한다.</p>
     *
    ...
    public void setBarcodeMsg(final String msg) {
        ...
        // 개발66 Step 7 : 비생산 6종(0·2·3·4·5·6) 전부 타입 구현체로 이관 완료. 과도기 분기 제거
